...
public class PhotoListScreen extends List {
	...
	static final Command viewCommand = new Command("View", Command.ITEM, 1);
	static final Command addCommand = new Command("Add", Command.ITEM, 1);
	static final Command deleteCommand = new Command("Delete", Command.ITEM, 1);
