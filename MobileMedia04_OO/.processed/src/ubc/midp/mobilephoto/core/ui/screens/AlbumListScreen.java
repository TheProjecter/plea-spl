...
public class AlbumListScreen extends List {
	...
	static final Command selectCommand = new Command("Select", Command.ITEM, 1);
	static final Command createAlbumCommand = new Command("New Photo Album", Command.ITEM, 1);
	static final Command deleteAlbumCommand = new Command("Delete Album", Command.ITEM, 1);
	static final Command resetCommand = new Command("Reset", Command.ITEM, 1);
