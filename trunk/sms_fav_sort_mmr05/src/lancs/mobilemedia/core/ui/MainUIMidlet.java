...
public class MainUIMidlet extends MIDlet {
	...
	public void startApp() throws MIDletStateChangeException {
		...
		// #if includeCopyPhoto || includeSmsFeature
		PhotoViewController photoViewController = new PhotoViewController(this, model, album, "image name");
		photoViewController.commandAction(command, album);
		//#endif
		
		//#ifdef inlcudeSmsFeature
		SmsSenderController smsSenderController = new SmsSenderController(this, model, album, "image name");
		smsSenderController.commandAction(command, album);
		
		SmsReceiverController smsReceiverController = new SmsReceiverController(this, model, album);
